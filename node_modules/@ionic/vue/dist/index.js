...
const IonRouterOutlet = defineComponent({
    ...
    render() {
        ...
        components && components.map((c) => {
             ...
             */
            if ((_b = (_a = c.matchedRoute) === null || _a === void 0 ? void 0 : _a.props) === null || _b === void 0 ? void 0 : _b.default) {
...
const IonTabs = defineComponent({
    ...
    render() {
        ...
        if (slottedContent && slottedContent.length > 0) {
            const topSlottedTabBar = slottedContent.find((child) => {
                var _a;
                const isTabBar = child.type && child.type.name === 'IonTabBar';
                const hasTopSlot = ((_a = child.props) === null || _a === void 0 ? void 0 : _a.slot) === 'top';
